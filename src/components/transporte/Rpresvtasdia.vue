          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Resumen Ventas por dia</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
        </v-card-title>
...
export default {
  ...
  methods: {
    ...
    print_reporte_excel() {
      ...
      var header_format = [
        { text: "RESUMEN VENTAS POR DIA", bold: true, size: 16 },
      ...
      this.pdfs.getBase64(logo_src).then((logo) => {
        this.excel
          ._informe({
            sheetName: "Resumen Ventas por Dia Agencia",
            ...
            archivo: `RESUMEN_VTAS_DIA-${new Date().getTime()}`,
          })
          .then((data) => {
    ...
    consultar_reporte() {
      if (this.form.puntos) {
        ...
        var datos = {
          url: "Transporte/dlls/RpResVtasdiaJ.dll",
          data:
