                ...
                <v-row class="mt-1 ml-1">
                  ...
                  <v-col class="d-flex" cols="4" sm="3">
                    <v-text-field
                      ...
                      @input="errores.propietario = false"
                      hide-details
                    ></v-text-field>
                  </v-col>
                  <v-col class="d-flex" cols="4" sm="3">
            ...
            <v-tab-item>
              <v-card color="basil" flat>
                ...
                <v-row class="mb-1 ml-1">
                  <v-col class="d-flex" cols="4" sm="3">
                    <v-text-field
                      label="Valor excluido"
                      clearable
                      outlined
                      required
                      v-model="form.vlrexcluido"
                      hide-details
                    ></v-text-field>
                  </v-col>

                  <v-col class="d-flex" cols="12" sm="4">
                    <v-switch v-model="form.excluido" label="Excluido Cartera"></v-switch>
                  </v-col>
...
export default {
  ...
  data() {
    return {
      ...
      tablaccosto: [],
      tipovehiculo: [
        { text: "Microbus -14 Pasajeros", value: 6 },

        { text: "Microbus -15 Pasajeros", value: 4 },

        { text: "Microbus -16 Pasajeros", value: 1 },
        { text: "Microbus -17 Pasajeros", value: 2 },
        { text: "Microbus -18 Pasajeros", value: 8 },

        { text: "Microbus -19 Pasajeros", value: 19 },
        { text: "Taxi     -8  Pasajeros", value: 3 },
        { text: "Bus Preferencial -44 Pasajeros", value: 5 },
        { text: "Taxi      -4 Pasajeros", value: 7 },
        { text: "Bus      -36 Pasajeros", value: 9 },
        { text: "Bus      -38 Pasajeros", value: 10 },
        { text: "Bus      -40 Pasajeros", value: 11 },
        { text: "Bus      -42 Pasajeros", value: 12 },
        { text: "Bus      -44 Pasajeros", value: 13 },
        { text: "Taxi     -9 Pasajeros", value: 14 },
      ],
      tipocombustible: [
  ...
  methods: {
    ...
    editar_item(data) {
      ...
      this.form.excluido = item.excluido_rep == "1" ? true : false;
      this.form.vlrexcluido = item.vlrexcluido_rep.trim();
    ...
    format_envio(data) {
      ...
      var vencetopera = data.vencetopera.replace(/\-/g, "");
      ...
      var conductor3 = data.conductor3
        ...
        : "0";
      var fmatricula = data.fmatricula.replace(/\-/g, "");
      var nrosoat = data.nrosoat;
      var asegsoat = data.asegsoat;
      var vencesoat = data.vencesoat.replace(/\-/g, "");
      var nrotecno = data.nrotecno;
      var emprtecno = data.cda;
      var vencetecno = data.vencetecno.replace(/\-/g, "");
      var nrotodor = data.nrotodoriesgo;
      var asegtodor = data.asegtodor;
      var vencetodor = data.vencetodor.replace(/\-/g, "");
      var nrocontractual = data.nrocontra;
      var asegcontract = data.asegcontra;
      var vencecontract = data.vencecontra.replace(/\-/g, "");
      var ccosto = data.ccosto;
      var fafiliacion = data.fecha_afiliacion.replace(/\-/g, "");
      ...
      let sdocartera = data.sdocartera;
      let vlrexcluido = data.vlrexcluido;
      var estado = data.estado ? "1" : "0";
      var eliminar = data.eliminar ? "1" : "0";
      var excluido = data.excluido ? "1" : "0";
    ...
    print_reporte_excel() {
      ...
      var columnas = [
        ...
        {
          title: "id_interno_Propietario",
          value: "idprop_rep",
        },
        {
          title: "Identificacion_Propietario",
          value: "ccpropietario_rep",
        },
        ...
        {
          title: "Saldo Cartera",
          value: "sdocartera_rep",
        },
        {
          title: "Vlr Excluido",
          value: "vlrexcluido_rep",
        },
