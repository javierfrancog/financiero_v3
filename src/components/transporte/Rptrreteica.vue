          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Reporte de Retencion de Ica</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
        </v-card-title>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Libro", align: "center", value: "libro_rep" },        
        { text: "Vlr_Contado", align: "center", value: "subtotal_lvia" },
        { text: "Vlr Ica", align: "center", value: "vlrica_lvia" },
      ],
      errores: {
        placas: false,
      },
  ...
  methods: {
    ...
    print_reporte_excel() {
      ...
      var data_parse = data.map((el) => {
        ...
        let ica = parseFloat(el.vlrica_lvia.replace(/\,/g, "")) || 0;
      ...
      var header_format = [
        { text: "REPORTE PROVISION RETEICA", bold: true, size: 16 },
      ...
      this.pdfs.getBase64(logo_src).then((logo) => {
        this.excel
          ._informe({
            ...
            archivo: `REPORTE-RETEICA-${new Date().getTime()}`,
          })
          .then((data) => {
    ...
    consultar_reporte() {
      ...
      this.postData({
        url: "Transporte/dlls/RpReteicaJ.dll",
        data: data.join("|") + "|",
        method: "",
      })
        .then((data) => {
          ...
          this.contenido.forEach((el) => {
            let valor = parseFloat(el.subtotal_lvia.replace(/\,/g, "")) || 0;
