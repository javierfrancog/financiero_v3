          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Configuración Actividades de Producción</v-list-item-title
              >
            </v-list-item-content>
            <v-row justify="end">
              <v-btn
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Descripción", align: "center", value: "descrip_rep" },
...
methods: {
    ...
    opcionDialog(opc, key) {
      this.form = [];
      if (opc == "C") {
        this.form.text = "Agregar Actividad de Producción";
        ...
        if (item) {
          this.form = {
            text: "Modificar Actividad de Producción",
            codigo: item.cod_rep,
    ...
    guardarFormulario() {
      if (this.$refs.form.validate()) {
        ...
        var datos = {
          url: "Financiero/dlls/CfActivProd.DLL",
          data:
