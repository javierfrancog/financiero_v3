    ...
    <v-flex xs12 md12>
      <v-card class="mx-auto col-12" max-width="1300" elevation="2">
        <v-card-title>
          <v-list-item>
            <v-list-item-icon>
              <v-icon size="30" color="blue darken-4 ">mdi-map-marker-plus-outline</v-icon>
            </v-list-item-icon>
            <v-list-item-content>
              <v-list-item-title class="headline">Configuración Ubicaciones</v-list-item-title>
            </v-list-item-content>
            <v-row justify="end">
              <v-btn
                color="success"
        ...
        <v-card-text class="pb-0">
          <v-row>
            ...
            <v-col class="d-flex" cols="12" sm="4">
              <v-switch v-model="form.consigna" label="Mcias en Consignación"></v-switch>
            </v-col>
          </v-row>
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Codigo", align: "left", value: "codigo_ubic" },
        { text: "Descripción", align: "left", value: "descrip_ubic" },
  ...
  methods: {
    editar_item(data) {
      ...
      this.dialogo.tipo = 1;
      this.form.codigo = item.codigo_ubic;
      this.form.descripcion = item.descrip_ubic;
      this.form.consigna = item.consigna_ubic == "1" ? true : false;
    ...
    format_envio(data) {
      ...
      var consigna = data.consigna ? "1" : "0";            
      var estado = data.estado ? "1" : "0";      
      var eliminar = data.eliminar ? "1" : "0";

      let datos = {
        url: "Financiero/dlls/CfUbicaciones.dll",
        data:
