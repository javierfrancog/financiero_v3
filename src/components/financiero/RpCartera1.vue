            ...
            <v-row>
              ...
              <v-col class="d-flex" cols="5">
                <v-autocomplete
                  ...
                  return-object
                  outlined
                  v-if="form.asesor && form.asesor.value != 1"
                ></v-autocomplete>
              </v-col>
  ...
  methods: {
    ...
    cargarcontenido() {
      ...
      if (!data.ruts) {
        ...
        var asesor = data.selasesor ? data.selasesor.idases : null;
        var punto = data.punto_fact.codigo_agc;
        var tiporut = data.ruts.value;
        var tipoases = data.asesor.value;
        var fechaFinal = data.fechaInicial.replace(/\-/g, "");
        let calldll = "";
        if (this.empresa.contarem_empr == 1) {
          calldll = "Ptovta/dlls/RpCartRemJ.DLL";
        } else {
          calldll = "Ptovta/dlls/RpCarteraJ.DLL";
        }
