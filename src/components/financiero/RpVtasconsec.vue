      ...
      <v-card class="mx-auto col-12" max-width="1300" elevation="2">
        <v-card-title>
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline">Reporte Ventas por Consecutivo</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        </v-card-title>
        <div class="pa-0 px-8">
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Subt_Fact", align: "center", value: "subtotalfact_rep" },        
        { text: "Dctos_Fact", align: "center", value: "dctofact_rep" },
        { text: "Iva_Fact", align: "center", value: "ivafact_rep" },
        { text: "Total_Factura", align: "center", value: "totalfact_rep" },
        { text: "Subt_Nc", align: "center", value: "subtotalnc_rep" },        
        { text: "Dctos_Nc", align: "center", value: "dctonc_rep" },
        { text: "Iva_Nc", align: "center", value: "ivanc_rep" },
        { text: "Total_Nc", align: "center", value: "totalfact_rep" },
  ...
  methods: {
    generar_excel() {
      ...
      data.forEach((el)=>{
        data_parse.push({
          tipodoc_rep: this.validaCampo(el.tipodoc_rep, 3),          
          numero_rep: this.validaCampo(el.numero_rep, 3),                    
          ...
          subtotalfact_rep: this.validaCampo(el.subtotalfact_rep, 2),
          dctofact_rep: this.validaCampo(el.dctofact_rep, 2),
          ivafact_rep: this.validaCampo(el.ivafact_rep, 2),
          totalfact_rep: this.validaCampo(el.totalfact_rep, 2),          
          subtotalnc_rep: this.validaCampo(el.subtotalnc_rep, 2),
          dctonc_rep: this.validaCampo(el.dctonc_rep, 2),
          ivanc_rep: this.validaCampo(el.ivanc_rep, 2),
          totalnc_rep: this.validaCampo(el.totalnc_rep, 2),          
      ...
      var header = [
        ...
        "Reporte Consecutivo Ventas".toUpperCase(),
      ...
      this.pdfs.getBase64(logo_src).then((logo) => {
        this.excel
          ._informe({
            sheetName: "Ventas x consecutivo",
            header: header,
            logo,
            tabla: {
              columnas: columnas,
            ...
            archivo: `Ventas-Consecutivo-${new Date().getTime()}`,
          })
          .then((data) => {
    ...
    cargarcontenido() {
      ...
      post
          .postData({
            url: "ptovta/dlls/RpVtaconsecJ.dll",
            data:
