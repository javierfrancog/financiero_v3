          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Configuración Agencias/Sucursales</v-list-item-title
              >
            </v-list-item-content>
            <v-row justify="end">
              <v-btn
...
export default {
  ...
  methods: {
    ...
    editar_item(data) {
      ...
      this.form.direccion = item.direccion_agc.trim();
      this.form.telefono = item.telefono_agc.trim();
    ...
    format_envio(data) {
      ...
      var direccion = data.direccion ? data.direccion.trim() : "";
      var telefono = data.telefono ? data.telefono.trim() : "";

      var eliminar = data.eliminar ? "1" : "0";

      let datos = {
        url: "Financiero/dlls/Cfagencias.dll",
        data:
