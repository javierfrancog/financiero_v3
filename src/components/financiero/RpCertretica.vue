          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline ml-2"
                >Certificado Retención de Ica</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
        </v-card-title>
...
export default {
  ...
  methods: {
    generar_pdf() {
      ...
      let periodo = "Desde " + this.form.fechaini + " Hasta " + this.form.fechafin
            ...
            return [
              {
                ...
                columns: [
                  ...
                  },
                  {
                    ...
                    fontSize: 13,
                    stack: [
                      "CERTIFICADO DE RETENCIÓN INDUSTRIA Y COMERCIO",
                      "PERIODO: " + periodo,
    ...
    consultar_rut() {
      if (!this.form.fechaini|| !this.form.fechafin) {
        ...
        post
          .postData({
            url: "Financiero/dlls/RpCertRteicaJ.dll",
