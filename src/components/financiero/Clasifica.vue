      ...
      <v-card class="mx-auto col-12" max-width="1300" elevation="2">
        <v-card-title>
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline">Configuración Clasificaciones</v-list-item-title>
            </v-list-item-content>
            <v-row justify="end">
              <v-btn
                color="success"
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Codigo", align: "center", value: "codigo_clas" },
        { text: "Descripción", align: "left", value: "descripcion_clas" },
  ...
  methods: {
    editar_item(data) {
      ...
      this.dialogo.tipo = 1;
      this.form.codigo = item.codigo_clas;
      this.form.descripcion = item.descripcion_clas;
    },
    guardar: function() {
    ...
    format_envio(data) {
      ...
      let datos = {
        url: "Financiero/dlls/CfClasifica.dll",
        data:
