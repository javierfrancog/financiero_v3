          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Reimpresión Remisiones</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
        </v-card-title>
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "F.Pago", align: "center", value: "formapago_fact" },
  ...
  methods: {
      ...
      post
        ...
        .then((data) => {
          ...
          if (this.empresa.molino_empr) {
            this.impresion_molino(data_impresion);
          } else if (this.empresa.posremis_empr == 1) {
    ...
    delete_item(item) {
      ...
      post
        .postData({
          url: "Ptovta/dlls/PrAnulaRem.dll",
          data: datosEnvio,
          method: "",
        })
        .then((data) => {
          this.$emit("snack", {
            color: "success",
            text: "Remisión anulada correctamente",
            estado: true,
          });
          this.card.loader = false;
          this.card.disabled = false;
    ...
    cargar_empresa() {
      post
        ...
        .then((data) => {
          this.empresa = data[0];
          this.form.punto_fact = this.empresa.ptoperfil_empr;
