    ...
    <v-flex xs12 md12>
      <v-card class="mx-auto col-12" max-width="1300" elevation="2">
        <v-card-title>
          <v-list-item>
            <v-list-item-icon>
              <v-icon size="30" color="blue darken-4 "
                >mdi-percent-box-outline</v-icon
              >
            </v-list-item-icon>
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Configuración Exogena ICA</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
          <v-row>
            ...
            <v-col class="d-flex" cols="4" v-if="selbta">
              <v-autocomplete
                :items="formatosbta"
          ...
          <v-row>
            <v-col class="d-flex " cols="3" v-if="selbta">
              <v-btn
                color="indigo"
...
export default {
  ...
  data() {
    return {
      ...
      formatosbta: [
        { text: "Ingresos -Art. 1-", value: 1100101 },
        { text: "Compras -Art. 2-", value: 1100102 },
        { text: "Venta Bienes -Art. 3-", value: 1100103 },
        { text: "Reteica -Art. 4-", value: 1100104 },
        { text: "Sujetos Reteica -Art. 6-", value: 1100105 },
        { text: "Ingresos Recibidos Terceros -Art. 10-", value: 1100106 },
        { text: "Ingresos Fuera Bogotá -Art. 14-", value: 1100107 },
      ],
      errores: {
        codigo: false,
        estado: false,
