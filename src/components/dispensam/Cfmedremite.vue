          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Medico Remitente</v-list-item-title
              >
            </v-list-item-content>
            <v-row justify="end">
              <v-btn
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Id", align: "center", value: "cod_rep" },
  ...
  methods: {
    get_especialidad() {
      ...
      post
        ...
        .then((data) => {
          data.pop();
          this.loader = false;
          this.especialidad = JSON.parse(JSON.stringify(data));
        })
        .catch((err) => {
          this.loader = false;
          this.$emit("snack", {
    ...
    editar_item(data) {
      ...
      var busqueda = this.especialidad.find(
        (el) => el.codigo_rep == item.especialidad_rep
      );
      this.form.especialidad = busqueda;
    ...
    format_envio(data) {
      ...
      let datos = {
        url: "Dispensa/dlls/Cfmedremite.dll",
        data:
