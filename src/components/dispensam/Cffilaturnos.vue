    ...
    <v-flex xs12 md12>
      <v-card class="mx-auto col-12" max-width="1300" elevation="2">
        <v-card-title>
          <v-list-item>
            <v-list-item-icon>
              <v-icon size="30" color="blue darken-4 ">mdi-apple-keyboard-caps</v-icon>
            </v-list-item-icon>
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Configuración Filas Turnero</v-list-item-title
              >
            </v-list-item-content>
            <v-row justify="end">
              <v-btn
          ...
          <v-row>
            ...
            <v-col class="d-flex" cols="3">
              <v-text-field
                ...
                outlined
                required
                v-model="form.idpublico"
                :error="errores.idpublico"
                @input="errores.idpublico = false"
                hide-details
              ></v-text-field>
            </v-col>
...
export default {
  ...
  methods: {
    editar_item(data) {
      ...
      this.form.idpublico = item.idturno_rep.trim();
    ...
    format_envio(data) {
      ...
      let idturno = data.idpublico;
      var descripcion = data.descripcion.replace(/\*/g, "x");
      var eliminar = data.eliminar ? "1" : "0";

      let datos = {
        url: "Dispensa/dlls/Cffilaturno.dll",
        data:
    ...
    agregar_item() {
      ...
      post
        .postData({
          url: "Dispensa/dlls/CffilaturnoN.dll",
