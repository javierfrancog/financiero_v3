<template>
  <v-layout wrap justify-center class="pa-6">
          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Reporte Detallado Dispensación</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
        </v-card-title>
    ...
    <v-dialog v-model="dialogocargue.estado" max-width="900px">
      <template>
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Eps", align: "center", value: "descripeps_rep" },
  ...
  methods: {
    ...
    async printpend_item(item) {
      let consecutivo = item.nropte_rep;
