          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline ml-2"
                >Rotación de Productos</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
        </v-card-title>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Pendiente", align: "center", value: "ptes_rep" },
      ],
      card: {
        loader: false,
        estado: false,
  ...
  methods: {
    consultar_reporte() {
      if (!this.form.fechaInicial) {
        ...
        let url_envio = "dispensa/dlls/RpRotacionJ.dll";
        if (detalle == 0) {
          url_envio = "dispensa/dlls/RpRotacion2J.dll";
        }
    ...
    print_reporte_excel() {
      ...
      var header_format = [
        { text: "REPORTE ROTACION", bold: true, size: 16 },
      ...
      this.pdfs.getBase64(logo_src).then((logo) => {
        this.excel
          ._informe({
            ...
            archivo: `REPORTE ROTACION-${new Date().getTime()}`,
          })
          .then((data) => {
