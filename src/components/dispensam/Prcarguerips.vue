          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Cargue de Rips</v-list-item-title
              >
            </v-list-item-content>
            <v-row justify="end">
  ...
  methods: {
    ...
    cargar_facturas() {
      if (!this.form.limite) {
        ...
        let contrato1 = this.form.contrato_select.nro_rep;
        let contrato2 = "0";
        let datos = {
          url: "Dispensa/dlls/PrRips01.dll",
          data:
