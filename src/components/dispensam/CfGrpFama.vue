          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Grupos Farmacológicos</v-list-item-title
              >
            </v-list-item-content>
            <v-row justify="end">
              <v-btn
...
export default {
  ...
  methods: {
    editar_item(data) {
      ...
      this.form.nivel = { value: parseInt(item.nivel_rep) };      
    ...
    format_envio(data) {
      ...
      let nivel = data.nivel.value;
      var eliminar = data.eliminar ? "1" : "0";

      let datos = {
        url: "Dispensa/dlls/CfGrpfarma.dll",
        data:
    ...
    agregar_item() {
      ...
      post
        .postData({
          url: "Dispensa/dlls/CfGrpfarmaN.dll",
