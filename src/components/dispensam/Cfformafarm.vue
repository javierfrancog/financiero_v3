    ...
    <v-flex xs12 md12>
      <v-card class="mx-auto col-12" max-width="1300" elevation="2">
        <v-card-title>
          <v-list-item>
            <v-list-item-icon>
              <v-icon size="30" color="blue darken-4 ">mdi-cube-send</v-icon>
            </v-list-item-icon>
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Formas Farmacéuticas</v-list-item-title
              >
            </v-list-item-content>
            <v-row justify="end">
              <v-col>
...
export default {
  ...
  methods: {
    ...
    format_envio(data) {
      ...
      let datos = {
        url: "Dispensa/dlls/Cfformafarmac.dll",
        data:
    ...
    print_reporte_excel() {
      ...
      var header_format = [
        { text: "REPORTE FORMA FARMACEUTICA", bold: true, size: 16 },
      ];
      ...
      this.pdfs.getBase64(logo_src).then((logo) => {
        this.excel
          ._informe({
            sheetName: "Reporte Forma Farmaceutica",
            ...
            archivo: `REPORTE FORMA FARMACEUTICA-${new Date().getTime()}`,
          })
          .then((data) => {
    ...
    agregar_item() {
      ...
      post
        .postData({
          url: "Dispensa/dlls/CfformafarmacN.dll",
