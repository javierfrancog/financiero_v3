      ...
      <v-card class="mx-auto col-12" max-width="1300" elevation="2">
        <v-card-title>
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline">Configuración Grados</v-list-item-title>
            </v-list-item-content>
            <v-row justify="end">
              <v-btn
                color="success"
        ...
        <div class="pa-0 px-8">
          <v-card-text class="px-0 pa-0">
            ...
            >
              <template
                v-slot:item.estadobase_rep="{item}"
              >{{ item.estadobase_rep == "1" ? "Bloqueado" : "Activo" }}</template>
...
export default {
  ...
  methods: {
    ...
    format_envio(data) {
      ...
      let datos = {
        url: "Colegios/dlls/Cfgrados.dll",
        data:
    ...
    buscarNumero: function () {
      ...
      if (clasifica) {
        ...
        post
          .postData({
            url: "Colegios/dlls/CfGradosN.dll",
