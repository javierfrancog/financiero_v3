    ...
    <v-flex xs12 md12>
      <v-card class="mx-auto col-12" max-width="1300" elevation="2">
        <v-card-title>
          <v-list-item>
            <v-list-item-icon>
              <v-icon size="30" color="blue darken-4 ">mdi-google-circles-group</v-icon>
            </v-list-item-icon>
            <v-list-item-content>
              <v-list-item-title class="headline">Configuración Procesos</v-list-item-title>
            </v-list-item-content>
            <v-row justify="end">
              <v-btn
                color="success"
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Codigo", align: "center", value: "nroproc_rep" },
        { text: "Descripción", align: "center", value: "descriproc_rep" },
        { text: "Estado", align: "center", value: "estadoproc_rep" },
  ...
  methods: {
    editar_item(data) {
      ...
      this.dialogo.tipo = 1;
      this.form.codigo = item.nroproc_rep;
      this.form.descripcion = item.descriproc_rep;
      this.form.estado = item.estadoproc_rep == "1" ? true : false;
    },
    guardar: function() {
    ...
    format_envio(data) {
      ...
      let datos = {
        url: "Financiero/dlls/CfActprocesos.dll",
        data:
    ...
    buscarNumero: function() {
      post
        .postData({
          url: "Financiero/dlls/CfActprocesosN.dll",
          data: sessionStorage.Sesion + "|",
          method: ""
        })
        .then(data => {
