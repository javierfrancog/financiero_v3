      ...
      <v-card class="mx-auto col-12" max-width="1300" elevation="2">
        <v-card-title>
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline">Configuración Actividades</v-list-item-title>
            </v-list-item-content>
            <v-row justify="end">
              <v-btn
                color="success"
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Codigo", align: "center", value: "nroactiv_rep" },
        { text: "Descripción", align: "left", value: "descripactiv_rep" },
        { text: "Estado", align: "center", value: "estadoactiv_rep" },
  ...
  methods: {
    editar_item(data) {
      ...
      this.dialogo.tipo = 1;
      this.form.codigo = item.nroactiv_rep;
      this.form.descripcion = item.descripactiv_rep;
    ...
    format_envio(data) {
      ...
      let datos = {
        url: "Financiero/dlls/CfActactividad.dll",
        data:
    ...
    buscarNumero: function() {
      post
        .postData({
          url: "Financiero/dlls/CfActactividadN.dll",
          data: sessionStorage.Sesion + "|",
          method: ""
        })
        .then(data => {
          this.form.codigo = data[0].nroact_rep;
        })
        .catch(err => {
          this.$emit("snack", {
            color: "error",
