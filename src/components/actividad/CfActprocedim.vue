    ...
    <v-flex xs12 md12>
      <v-card class="mx-auto col-12" max-width="1300" elevation="2">
        <v-card-title>
          <v-list-item>
            <v-list-item-icon>
              <v-icon size="30" color="blue darken-4 ">mdi-arrow-decision-outline</v-icon>
            </v-list-item-icon>
            <v-list-item-content>
              <v-list-item-title class="headline">Configuración Procedimientos</v-list-item-title>
            </v-list-item-content>
            <v-row justify="end">
              <v-btn
                color="success"
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Codigo", align: "center", value: "nroproced_rep" },
        { text: "Descripción", align: "left", value: "descriproced_rep" },
        { text: "Estado", align: "center", value: "estadoproced_rep" },
  ...
  methods: {
    editar_item(data) {
      ...
      this.dialogo.tipo = 1;
      this.form.codigo = item.nroproced_rep;
      this.form.descripcion = item.descriproced_rep;
    ...
    format_envio(data) {
      ...
      let datos = {
        url: "Financiero/dlls/CfActprocedim.dll",
        data:
