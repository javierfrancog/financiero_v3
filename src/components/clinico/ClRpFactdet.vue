          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Reporte Facturación Detallada cl</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
        </v-card-title>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Numero", align: "left", value: "numero_rep" },
        { text: "Fecha", align: "left", value: "fecha_Factura_rep" },
        ...
        { text: "Nro_Servicio", align: "center", value: "nroprserv_rep" },
        { text: "Nro_Rips", align: "center", value: "rips_rep" },
      ],
      empresa: [],
      card: {
        loader: false,
  ...
  methods: {
    print_reporte_excel() {
      ...
      data.forEach((el) => {
        ...
        copia.valorncred_rep =
          parseFloat(el.valorncred_rep.replace(/\,/g, "")) || 0;
      ...
      var columnas = [
        ...
        {
          title: "Factura Copago/Cuota",
          value: "facturacopago_rep",
        },
        ...
        {
          title: "N.Credito",
          value: "nroncredito_rep",
          format: "string",
          totalsRowFunction: "sum",
        },

        {
          title: "Valor N.Credito",
          value: "valorncred_rep",
          format: "money",
          totalsRowFunction: "sum",
        },
        ...
        },
        {
          ...
          value: "fecha_radicado_rep",
        },
        {
          title: "Nro Radicado",
          value: "nro_radicado_rep",
        },
        {
          title: "Vlr Radicado",
          value: "vlor_radicado_rep",
          format: "money",
          totalsRowFunction: "sum",
        },
      ];
    ...
    consultarServicios() {
      ...
      if (consulta) {
        if (estado_fecha) {
          ...
          post
            .postData({
              url: "Clinico/dlls/ClRpFactdetJ.dll",
              data:
