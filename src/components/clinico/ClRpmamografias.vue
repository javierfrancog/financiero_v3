    ...
    <v-flex xs12 md12>
      ...
      >
        <v-card-title>
          <v-list-item>
            <v-list-item-icon>
              <v-icon size="30" color="blue darken-4 ">mdi-face-woman-shimmer-outline</v-icon>
            </v-list-item-icon>
            <v-list-item-content>
              <v-list-item-title class="headline">Reporte Mamografias</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        </v-card-title>
        <div class="pa-0 px-8">
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Birads", align: "center", value: "birads_rep" }
      ],
      card_estado: false,
      btnEnvio: {
        loader: false,
    ...
    generar_excel() {
      ...
      data.forEach((el, index)=>{
          ...
          data_parse.push({
            ...
            birads_rep: (el.birads_rep === undefined)?"":el.birads_rep.trim(),                                    
          });
      });
      data_parse.pop();
      ...
      var header = [
        ...
        "Reporte de Mamografias".toUpperCase(),
      ...
      this.pdfs.getBase64(logo_src).then((logo) => {
        this.excel
          ._informe({
            sheetName: "Reporte de Mamografias",
            header: header,
            logo,
            tabla: {
              columnas: columnas,
            ...
            archivo: `MAMOGRAFIAS-${new Date().getTime()}`,
          })
          .then((data) => {
