      ...
      <v-card class="mx-auto col-12" max-width="1300" elevation="2">
        <v-card-title>
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline ml-2">Contabilizar Facturas cl</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        </v-card-title>
        <div class="pa-0 px-8">
...
export default {
  ...
  methods: {
    ...
    get_comprobantes() {
      ...
      var prefijo = this.form.prefijo.prefijo_resd
      let doc_contab = this.form.prefijo.doconta_resd;
      post
        .postData({
          url: "Clinico/dlls/ClPrContfact.dll",
          data: sessionStorage.Sesion + "|" + fecha + "|" + prefijo + "|" + doc_contab + "|",
          method: ""
        })
        .then(data => {
          this.loader = false;
