          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >ImpresiÃ³n Prima de Servicio</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
        </v-card-title>
  ...
  methods: {
    ...
    generar_excel() {
      ...
      this.pdfs.getBase64(logo_src).then((logo) => {
        this.excel
          ._informe({
            sheetName: "Planilla Prima de Servicios",
            header: header,
            logo,
            tabla: {
              columnas,
            ...
            archivo: `PLANILLA-PRIMA-${new Date().getTime()}`,
          })
          .then((data) => {
            ...
            return [
              {
                ...
                columns: [
                  ...
                  },
                  {
                    ...
                    alignment: "center",
                    stack: [
                      "Planilla Prima de Servicios".toUpperCase(),
                      periodo,
                    ],
                  },
                ],
