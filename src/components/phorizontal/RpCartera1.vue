...
export default {
  ...
  methods: {
    ...
    descargar_pdf() {
      ...
      data_format.push([
        { text: "Unidad", style: "header_table" },
        ...
        { text: "Vencido Hasta 30 Dias", style: "header_table" },
        { text: "Vencido Hasta 60 Dias", style: "header_table" },
        { text: "Vencido Hasta 90 Dias", style: "header_table" },
        { text: "Mayor a 90 dias", style: "header_table" },
    ...
    descargar_excel() {
      ...
      data.forEach((el, i) => {
        ...
        copia.v030_rep = parseFloat(el.v030_rep) || 0;
        copia.v060_rep = parseFloat(el.v060_rep) || 0;
        copia.v090_rep = parseFloat(el.v090_rep) || 0;
        copia.v180_rep = parseFloat(el.v180_rep) || 0;        
        copia.v360_rep = parseFloat(el.v360_rep) || 0;        
        copia.vmayor360_rep = parseFloat(el.vmayor360_rep) || 0;

        data_parse.push(copia);
        if (el.vence_rep === "Sub-total:") {
          data_parse.push({
            id_rep: "",
            descripcion_rep: "",
            pref_rep: "",
      ...
      let header_format = [
        { text: "REPORTE DE CARTERA POR EDADES", bold: true, size: 16 },
    ...
    cargarcontenido() {
      ...
      if (!data.ruts) {
        ...
        let calldll = "Phorizontal/dlls/RpCarteraJ.DLL";
