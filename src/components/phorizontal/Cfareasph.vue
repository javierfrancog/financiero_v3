          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Configuración Areas</v-list-item-title
              >
            </v-list-item-content>
            <v-row justify="end">
              <v-btn
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Area", align: "left", value: "valor_rep" },
  ...
  methods: {
    editar_item(data) {
      ...
      this.form.areas = item.valor_rep.trim();
    },
    guardar: function () {
      var data = JSON.parse(JSON.stringify(this.form));
      if (!data.areas) {
        this.errores.areas = true;
        this.send_error("Area Obligatoria!");
      } else {
    ...
    format_envio(data) {
      ...
      let datos = {
        url: "Phorizontal/dlls/CfAreas.dll",
        data:
    ...
    get_consec() {
      ...
      post
        .postData({
          url: "Phorizontal/dlls/CfAreasN.dll",
          data: sessionStorage.Sesion + "|",
          method: "",
        })
        .then((data) => {
