...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        // { text: "Base Venta", align: "center", value: "bventa_pr" },
  ...
  methods: {
    ...
    editar_item(data) {
      ...
      post
        ...
        .then((data) => {
          ...
          let descripcion64 = "";
          if (item.base1_pr.trim() == "") {
            descripcion64 = window.atob(item.descripcion_pr.trim());
          } else {
    ...
    format_envio(data) {
      ...
      var descripcion = data.descripcion ? window.btoa(data.descripcion) : "";
      ...
      post
        ...
        .then((data) => {
          ...
          data_parse.map((el, index) => {
            if (el.descripcion_pr) {
              el.descripcion_completa = window.atob(el.descripcion_pr);
              el.index = index;
            }
            return el;
          });
