          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >ReimpresiÃ³n Liquidaciones</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
        </v-card-title>
            ...
            >
              ...
              <template v-slot:item.edit="{ item }">
                <v-tooltip top>
                  ...
                  <span>Imprimir LiquidaciÃ³n</span>
                </v-tooltip>
                ...
                <v-tooltip top>
                  ...
                  <span>Recontabilizar Liquidacion</span>
                </v-tooltip>
                <v-tooltip top>
                  <template v-slot:activator="{ on }">
                    <v-btn
  ...
  methods: {
    ...
    cargarcontenido() {
      ...
      if (!agencia) {
        ...
        post
          .postData({
            url: "Molinos/dlls/RpLiquida01J.dll",
            data:
