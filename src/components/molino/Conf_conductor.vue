          ...
          <v-card-text class="px-0 pa-0">
            ...
            >
              ...
              <template v-slot:item.edit="{ item }">
                ...
                <v-btn fab icon small>
                  <v-icon  color="indigo" class="mr-2" @click="imprimir_blanco(item)"
...
export default {
  ...
  methods: {
    ...
    imprimir_blanco(item) {
      ...
      Object.getOwnPropertyNames(data_impresion).forEach(function (val, idx, array) {
        data_impresion[val] = ''
      });
    ...
    validar_envio: function () {
      ...
      if (!data.tipoid) {
        ...
        console.log(imagenes, pdf, this.imagenes_subidas);
