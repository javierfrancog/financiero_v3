    ...
    <v-flex xs12 md12>
      ...
      >
        <v-card-title>
          <v-list-item>
            <v-list-item-icon>
              <v-icon size="30" color="blue darken-4 ">mdi-chevron-triple-right</v-icon>
            </v-list-item-icon>
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Reporte Ingreso de Mercancias</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
        </v-card-title>
        <div class="pa-0 px-8">
          <v-card-text class="px-0 pa-0">
            ...
            <v-data-table
              ...
              :search="search"
            >
            <template v-slot:item.item_pes="{ item }">
                {{ parseInt(item.item_pes) }}
              </template>
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        { text: "Item", align: "center", value: "item_pes" },
        { text: "Fecha", align: "left", value: "fecha_pes" },
        { text: "Placa", align: "center", value: "placa_pes" },
        { text: "Consecutivo", align: "center", value: "nro_pes" },
        ...
        { text: "Peso Entrada", align: "center", value: "pesoneto_pes" },
        { text: "Humedad", align: "center", value: "humini_pes" },
        { text: "Impureza", align: "center", value: "impini_pes" },
        { text: "Peso Neto", align: "left", value: "pesocomp_pes" },
