        ...
        <v-card-title>
          <v-list-item>
            ...
            <v-list-item-content>
              ...
              <v-list-item-subtitle>Activacion de SuperAdmin</v-list-item-subtitle>
            </v-list-item-content>
            <v-row justify="end">
                ...
                <v-form lazy-validation v-model="valid" ref="form">
                  <v-card>
                    ...
                    <v-card-text>
                      <v-container>
                        ...
                        <v-row>
                          ...
                          <v-col class="d-flex" cols="12" sm="4">
                            <v-select
                              :items="[{ text: 'Financiero',value: 1},{ text: 'Clinico',value: 2}]"
                              label="Perfil"
                              outlined
                              clearable
                              hide-details
                          ...
                          <v-col class="d-flex" cols="12" sm="4">
                            <v-select
                              :items="[{ text: 'Desactivado',value: 1},{ text: 'Activo',value: 2}]"
                              label="Estado"
                              outlined
                              clearable
                              hide-details
                    ...
                    <v-card-actions>
                      ...
                      <v-btn class="ma-2" color="success" text @click="guardar">Guardar</v-btn>
                    </v-card-actions>
                  </v-card>
                </v-form>
              </v-dialog>
