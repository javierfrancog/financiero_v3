                      ...
                      <v-container>
                        ...
                        <v-row>
                          <v-col class="d-flex" cols="12" sm="3">
                            <v-select
                              :items="[
                                { text: 'En Pruebas', value: 0 },
                                { text: 'Produccion', value: 1 },
                              ]"
                              label="Facturacion Electrónica"
                              outlined
                              clearable
                              hide-details
                              return-object
                              v-model="form.f_electr"
                              required
                              :rules="validField"
                            ></v-select>
                          </v-col>
                          ...
                          <v-col class="d-flex" cols="12" sm="3">
                            <v-select
                              :items="[
                                { text: 'Cuota Unica', value: 0 },
                                { text: 'Multiples Cuotas', value: 1 },
                              ]"
                              label="Cuotas"
                              outlined
                              clearable
  ...
  methods: {
    ...
    opcionDialog(opc, key) {
      ...
      if (opc == "C") {
        ...
        if (item.length) {
          ...
          this.form.cltoken = item.cltoken_empr;
          this.form.acctoken = item.actoken_empr;
          this.form.tipo_emp = {
          ...
          this.form.f_electr = {
            text: item.estadofe == "0" ? "Desactivado" : "Activo",
            value: parseInt(item.estadofe),
          };
          this.form.puc = {
            value: parseInt(item.puc_empr),
          };
          this.form.cargueprod = {
            value: parseInt(item.cargueprod_empr),
          };
          this.form.cuotas = {
            value: parseInt(item.cuotas_empr),
          };
          this.form.listas = {
            value: parseInt(item.listaspr_empr),
          };
    ...
    guardarCliente() {
      if (this.$refs.form.validate()) {
        ...
        var cltoken = this.form.cltoken;
        var accestoken = this.form.acctoken;
        var codhabilitacion = this.form.codhab;
        var f_electro = this.form.f_electr.value;
        var puc = this.form.puc.value;
        var carguepr = this.form.cargueprod.value;
        var cuotas = this.form.cuotas.value;
        var listas = this.form.listas.value;
