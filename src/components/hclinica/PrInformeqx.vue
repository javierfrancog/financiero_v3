          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Informe QuirÃºrgico</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
        </v-card-title>
        ...
        <v-dialog v-model="dialogo.estado" persistent max-width="1200px">
          <v-card class="px-6" :loading="card_estado" :disabled="card_estado">
            ...
            <v-card-text class="mt-2 pb-0">
              ...
              >
                <v-tab grow>Reporte Quirurgico</v-tab>
              </v-tabs>
                    ...
                    <v-row class="mt-2 ml-2">
                      <v-col cols="11">
                        <v-autocomplete
                          ...
                          item-value="codigo"
                          label="Diagnostico PreQuirurgico"
                          outlined
                          clearable
                          hide-details
                          return-object
                    ...
                    <v-row class="mt-2 ml-2">
                      <v-col cols="11">
                        <v-autocomplete
                          ...
                          :item-text="format_diagnostico"
                          item-value="codigo"
                          label="Diagnostico PostQuirurgico"
                          outlined
                          clearable
                          hide-details
                          return-object
                          v-model="form.dxpost"
                          :error="errores.dxpost"
                          @change="errores.dxpost = false"
                        ></v-autocomplete>
                      </v-col>
                    </v-row>
                    ...
                    <v-row v-if="imagePreviews.length > 0">
                      ...
                      >
                        <div style="position: relative">
                          ...
                          <!-- BotÃ³n de eliminar sobre la imagen -->
                          <v-btn
                            icon
                            color="red"
