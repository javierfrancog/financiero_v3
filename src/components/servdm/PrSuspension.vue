    ...
    <v-flex xs12 md12>
      ...
      >
        <v-card-title>
          <v-list-item>
            <v-list-item-icon>
              <v-icon size="30" color="blue darken-4 ">mdi-sync-off</v-icon>
            </v-list-item-icon>
            <v-list-item-content>
              <v-list-item-title class="headline"
                >SuspensiÃ³n de Servicio</v-list-item-title
              >
            </v-list-item-content>
  ...
  methods: {
    ...
    imprimir() {
      let datos = {
        ...
        data: sessionStorage.Sesion + "|" + 1 + "|" + this.consecutivo + "|",
        method: "",
      };
      post
        .postData(datos)
