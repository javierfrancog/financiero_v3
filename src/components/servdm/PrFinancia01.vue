          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Reimpresión de Financiaciones</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
        </v-card-title>
    ...
    editar_documento(item) {
      ...
      post
        ...
        .then((data) => {
          ...
          this.form.fechaini = item.fecha_rep;
