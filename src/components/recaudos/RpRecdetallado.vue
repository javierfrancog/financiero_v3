          ...
          <v-card-text class="px-0 pa-0">
            ...
            <v-row class="d-flex justify-end">
              ...
              <v-col class="d-flex" cols="2">
                <v-switch v-model="pterad" label="Solo Pendientes x Radicado">
                </v-switch>
              </v-col>
            </v-row>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Municipio", align: "center", value: "ciudad_rep" },
        { text: "F_Ingreso", align: "center", value: "ingreso_rep" },
        { text: "Estado", align: "center", value: "estado_rep" },
        { text: "Radicado1", align: "center", value: "radicado1_rep" },
      ],
      card_estado: false,
      btnEnvio: {
        loader: false,
  ...
  methods: {
    ...
    print_reporte_excel() {
      ...
      var columnas = [
        ...
        {
          title: "Fecha Extendido",
          value: "fechareg_rep",
          format: "string",
        },
        {
          title: "Hora Extendido",
          value: "horareg_rep",
          format: "string",
        },
        {
    ...
    consultar_reporte() {
      ...
      this.postData({
        url: "Recaudos/dlls/RpRecdetalladoJ.dll",
        data: data.join("|") + "|",
        method: "",
      })
        .then((data) => {
