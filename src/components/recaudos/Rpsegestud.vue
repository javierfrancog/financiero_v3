          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Recaudos Seguro Estudiantil</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
        </v-card-title>
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        { text: "Cedula", align: "left", value: "cedula_rep" },
        { text: "Estudiante", align: "left", value: "entidad_rep" },
        { text: "Colegio", align: "left", value: "entidad_rep" },
        { text: "Municipio", align: "center", value: "cantidad_rep" },
  ...
  methods: {
    ...
    cargaragencias: function () {
      post
        ...
        .then((data) => {
          ...
          let busqueda = this.ptosrecaudo.find(
            (el) => el.codigo_agc == "0"
          );
          this.form.puntos = busqueda;
    ...
    print_reporte() {
      ...
      data_parse.unshift([
        ...
        { text: "Cedula", style: "header_table" },
    ...
    consultar_reporte() {
      ...
      this.postData({
        url: "Recaudos/dlls/RpConvenioJ.dll",
        data: data.join("|") + "|",
        method: "",
      })
        .then((res) => {
