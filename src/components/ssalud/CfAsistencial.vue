...
export default {
  ...
  data() {
    return {
      ...
      items_tipo: [
        ...
        { text: "Medico Especialista", value: "04" },
        { text: "Psicologia", value: "05" },
        { text: "Terapeuta", value: "06" },
      ...
      headers: [
        ...
        { text: "Estado", align: "center", value: "descestado" },
  ...
  methods: {
    ...
    editar_item(data) {
      ...
      this.form.printfirma = item.firma == "1" ? true : false;

      var busqueda_tipo = this.items_tipo.find((el) => el.value == item.tipo);
      ...
      busqueda_espec = this.medicos.find((el) => el.id == item.idfirmante);
      this.form.firmante = busqueda_espec;

      let busqueda = this.consultorios.find(
        (el) => el.codigo_rep == item.sala
      );
    ...
    format_envio(data) {
      ...
      let id = data.id;
      let idfirmante = data.firmante ? data.firmante.id : 0;
      let descripcion = data.descripcion;
      let espec = data.especialidad.codigo_rep;
      let regmedico = data.regmedico.trim();
      let rango = data.rango;
      let tipoprof = data.tipoprof.value;
      let estado = data.estado ? "1" : "0";
      let eliminar = data.eliminar ? "1" : "0";
      let printfirma = data.printfirma ? "1" : "2";
      let consultorio = data.consultorio.codigo_rep;
    ...
    cargarcontenido() {
      ...
      post
        .postData({
          url: "Clinico/dlls/CfAsistecJ.dll",
          data: sessionStorage.Sesion + "|" + "1" + "|",
          method: "",
        })
        .then((data) => {
