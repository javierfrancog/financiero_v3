          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Cargue Cups a Contratos ss</v-list-item-title
              >
            </v-list-item-content>
...
export default {
  ...
  data() {
    return {
      ...
      cups: [],
      grupos: [
          { text: "Consultas", value: "CN" },
          { text: "Cardiología", value: "CR" },
  ...
  methods: {
    ...
    procesar_plano(nombre_adjunto) {
      ...
      post
        .postData({
          ...
          data: sessionStorage.Sesion + "|" + contrato + "|" + nombre_adjunto + "|",
          method: "",
        })
        .then((data) => {
    ...
    editar_item(data) {
      ...
      var busqueda_grupo = this.grupos.find(
        (el) => el.value == item.grupo
      );
