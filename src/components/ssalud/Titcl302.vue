          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title class="headline"
                >Configuración Clientes ss</v-list-item-title
              >
            </v-list-item-content>
            <v-row justify="end">
              <v-btn
...
export default {
  ...
  methods: {
    ...
    editar_item(data) {
      ...
      this.form.porcrtefte = parseInt(item.porcrtefte_rut);

      console.log(this.eps)      
      var busqueda_eps = this.eps.find(
        (el) => el.value == item.eps_rut
      );
