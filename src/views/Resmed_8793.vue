          ...
          <v-flex xs11 sm8 md9 lg8>
            <v-row
              ...
              :style="{
                position: 'relative',
                background:
                  'url(https://titansoluciones.cloud/img/reportesmd_login.png)',
              ...
              >
                ...
                >
                  <v-card-title
                    ...
                    >Acceso a Resultados Médicos</v-card-title
                  >
  ...
  methods: {
    ...
    ingresar: function () {
      if (this.$refs.obj.validate()) {
        this.loader = true;
        var data = {
          url: "Financiero/dlls/loginresmd.dll",
          data:
            "900108793" +
            "|" +
            this.usuario +
